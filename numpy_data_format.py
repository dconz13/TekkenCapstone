...
data = np.loadtxt('model backup/trial 5/episodesAndRewards.txt')
...
writer = pandas.ExcelWriter('model backup/trial 5/27_hour_test.xlsx')
hours_36.to_excel(writer, 'trial 5')
writer.save()
